...
import com.example.foodorderapp.databinding.HomeNewShopItemBinding;
import com.example.foodorderapp.model.ShopModel;

import java.util.ArrayList;
import java.util.List;

public class HomeShopNewAdapter extends RecyclerView.Adapter<HomeShopNewAdapter.ShopViewHolder> {
    ...
    protected static class ShopViewHolder extends RecyclerView.ViewHolder {
        private final HomeNewShopItemBinding binding;

        public ShopViewHolder(View itemView, OnItemClickListener listener) {
            super(itemView);
            binding = HomeNewShopItemBinding.bind(itemView);
    ...
    public HomeShopNewAdapter(OnItemClickListener onItemClickListener) {
    ...
    public ShopViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_new_shop_item, parent, false);
