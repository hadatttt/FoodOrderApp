...
public class MyOrdersActivity extends AppCompatActivity {
    ...
    private ArrayList<MyOrders> orderList, historyList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rvDelivery.setVisibility(View.VISIBLE);
                rvHistory.setVisibility(View.GONE);
                myOrdersAdapter = new MyOrdersAdapter(orderList, MyOrdersActivity.this);
                rvDelivery.setAdapter(myOrdersAdapter);
                myOrdersAdapter.notifyDataSetChanged();
            }
        });
        btnHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myOrdersAdapter = new MyOrdersAdapter(historyList, MyOrdersActivity.this);
                rvHistory.setAdapter(myOrdersAdapter);
                myOrdersAdapter.notifyDataSetChanged();
            }
        });
